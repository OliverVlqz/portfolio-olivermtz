...
export default function Header() {
  ...
  return (
    <header className='z-[999] relative'>
        ...
        h-[4.5rem] w-full 
        rounded-none boder border-white border-opacity-40
        ...
        sm:top-[1.7rem] sm:h-[initial] sm:py-0'>
          ...
          sm:w-[initial] sm:flex-nowrap sm:gap-5'>
            {links.map(link =>(
              ...
              >
                <Link className={clsx('flex w-full items-center justify-center px-3 py-3 hover:text-gray-950 transition dark:text-gray-500 dark:hover:text-gray-300', link.name === activeSection && 'text-gray-950 dark:text-gray-200')}
                 href={link.hash}
